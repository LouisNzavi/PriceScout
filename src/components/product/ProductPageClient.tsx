...
/** Product: 12-week price chart, promo history, alternatives, subscribe for alerts. */
            ...
            <div className="h-48 flex items-end gap-1">
              {product.history.map((h, i) => (
                <div
                  ...
                  style={{ height: `${Math.max(4, (h.avgPrice / Math.max(...product.history!.map((x) => x.avgPrice))) * 100}%` }}
